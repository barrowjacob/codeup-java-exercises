...
//
//            Scanner sc = new Scanner(System.in);
//        System.out.println("What is the title of the movie you'd like to make?");
//        String movieTitleInput = sc.nextLine();
//        System.out.println("What type of movie is it? (Genre: animated, drama, horror, scifi...)");
//        String movieCategoryInput = sc.nextLine();
//        newMovies = Arrays.copyOf(newMovies, newMovies.length + 1);
//        newMovies[newMovies.length-1].setName(movieTitleInput);
//        newMovies[newMovies.length-1].setCategory(movieCategoryInput);
//        System.out.println(newMovies[newMovies.length-1].getName());
//    }
}
