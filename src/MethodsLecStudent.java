...
public static void favoriteSong() {
    System.out.println("Lonely Road by Greenday");
}
/*
 ...
 */
    ...
    public static void orderFood(String newFood, Integer numberOrdered) {
        System.out.printf("I now want to order %s. Like, %d of them.%n", newFood, numberOrdered);
    }
 ...
 */
    public static void orderFood(String itemOne, String itemTwo) {
        System.out.printf("I would like to order %s and %s%n",itemOne, itemTwo);
    }
...
// each number. This is the one you'll call in your main()
    public static void main(String[] args) {
        orderFood();
        orderFood("burger");
        orderFood("burgers", 300);
        orderFood("salad", "pasta");
